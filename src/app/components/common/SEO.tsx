...
export default function SEO({ 
  ...
  const defaultTitle = 'Ranchi Taxi, Cab & Car Rental Service | Book 24/7 @ ₹10/km | ⭐5.0 Rated';
  const defaultDescription = 'Ranchi Taxi & Cab Service ⭐5.0 Rating - Book car rental 24/7. Local taxi ₹10/km, Ranchi to Dhanbad ₹2400, Airport cab ₹800, Outstation from ₹4500. AC Sedan, Ertiga, Innova Crysta. 100% verified drivers. Free cancellation. Call +91 7903629240!';
  const defaultKeywords = 'ranchi taxi, ranchi cab, car rental ranchi, ranchi to dhanbad, taxi service in ranchi, ranchi cab service, cab in ranchi, cab booking ranchi, ranchi airport taxi, outstation taxi ranchi, local taxi ranchi, birsa munda airport taxi, ranchi to patna cab, ranchi to kolkata taxi, ranchi to jamshedpur cab, cab near me ranchi, taxi near me ranchi, car hire ranchi, cheap taxi ranchi, best cab service ranchi, 24 hour taxi ranchi, online cab booking ranchi, innova on rent ranchi, ertiga taxi ranchi, one way taxi ranchi, round trip cab ranchi, jharkhand taxi service, ranchi to bokaro cab, cab in doranda, taxi lalpur ranchi, kanke cab service, harmu taxi, bariatu cab, morabadi taxi service, hinoo cab booking, hec ranchi cab, mecon ranchi taxi, ranchi lake taxi, pahari mandir cab, tagore hill taxi, dassam falls cab, rock garden ranchi taxi, hundru falls cab service, ranchi station taxi, airport transfer ranchi, wedding car ranchi, corporate taxi ranchi, tempo traveller ranchi 12 seater, dzire cab ranchi, aura taxi ranchi, crysta on rent ranchi, chauffeur driven car ranchi, reliable taxi jharkhand, safe cab ranchi';
